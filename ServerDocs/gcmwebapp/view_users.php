...
if( checkedCB == 0){
	...
	$.ajax({type: "POST",data: formData, url: "process_message.php", success:function(res){
...
<table>
<tr id="header"><td>Id</td><td>Email</td><td>Send Message?</td></tr>
<?php
...
<select id="festival">
<option value="http://10.0.4.58:8787/gcmwebapp/img/diwali.png">Diwali</option>
<option value="http://10.0.4.58:8787/gcmwebapp/img/pongal.png">Pongal</option>
<option value="http://10.0.4.58:8787/gcmwebapp/img/christmas.png">Christmas</option>
<option value="http://10.0.4.58:8787/gcmwebapp/img/ramzan.png">Ramadan</option>
</select>
<br/>
<img src="http://10.0.4.58:8787/gcmwebapp/img/diwali.png"/>
</div>
<div class="leftdiv">
